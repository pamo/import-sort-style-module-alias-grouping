...
exports.default = (styleApi, file, options) => {
    const { alias, and, dotSegmentCount, hasNamespaceMember, hasNoMember, isAbsoluteModule, isRelativeModule, isScopedModule, member, moduleName, naturally, not, unicode } = styleApi;
