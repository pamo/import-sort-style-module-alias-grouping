...
exports.default = (styleApi, file, options) => {
    const { alias, and, dotSegmentCount, hasNamespaceMember, hasNoMember, isAbsoluteModule, isRelativeModule, isScopedModule, moduleName, naturally, not, unicode } = styleApi;
